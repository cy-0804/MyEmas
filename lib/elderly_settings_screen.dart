...
class _ElderlySettingsScreenState extends State<ElderlySettingsScreen> {
  ...
  List<_SettingItem> get _visibleItems {
    final items = [
      _SettingItem(
        ...
        subtitle: 'Edit your personal info'.tr(),
        keywords: const [
          'name',
          'phone',
          'address',
      ...
      _SettingItem(
        ...
        title: 'Health Info'.tr(),
        subtitle: 'Edit allergies, blood type, and conditions'.tr(),
        keywords: const [
          'health',
          'allergy',
          'allergies',
        ...
        onTap: _openHealthInfo,
      ),
      if (!widget.isCaregiverMode) ...[
        _SettingItem(
          icon: Icons.lock_outline_rounded,
          title: 'Security & Data'.tr(),
          subtitle: 'Manage personal info'.tr(),
          keywords: const [
            'password',
            'biometric',
            'fingerprint',
        ...
        _SettingItem(
          ...
          title: 'Preference'.tr(),
          subtitle: 'App theme, language and accessibility settings'.tr(),
          keywords: const [
            'language',
            'font size',
            'text size',
      ...
      _SettingItem(
        ...
        subtitle: 'Notifications and reminder settings'.tr(),
        keywords: const [
          'push',
          'medication',
          'schedule',
      ...
      _SettingItem(
        ...
        title: 'Daily Sessions'.tr(),
        subtitle: 'Customize morning, afternoon, night routines'.tr(),
        keywords: const ['session', 'time', 'morning', 'night', 'schedule'],
        onTap: _openSessions,
      ),
      if (!widget.isCaregiverMode) ...[
        _SettingItem(
          ...
          title: 'Caregivers'.tr(),
          subtitle: 'Add or remove caregivers'.tr(),
          keywords: const [
            'caregiver',
            'unlink',
            'remove',
        ...
        _SettingItem(
          ...
          title: 'My QR Code'.tr(),
          subtitle: 'Share with your caregiver to link'.tr(),
        ...
        _SettingItem(
          ...
          title: 'Log out'.tr(),
          subtitle: 'Log out from your account'.tr(),
  ...
  void _openHealthInfo() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) =>
            HealthInfoScreen(isEditMode: true, elderlyId: widget.elderlyId),
      ),
    );
  }
    ...
    showDialog(
      ...
      builder: (dctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text('We will send a password reset link to your email.'.tr()),
  ...
  void _openPreference() {
    String selectedLang = AppSettings().language;
    bool largeText = AppSettings().textScaleFactor > 1.1;
    showModalBottomSheet(
      context: context,
      useRootNavigator: true,
      isScrollControlled: true,
            ...
            child: Column(
              ...
              children: [
                ...
                _tileRow(
                  ...
                  'Large Text'.tr(),
                  'Increase text size for readability'.tr(),
                  trailing: Switch(
                    value: largeText,
                    activeThumbColor: _kBlue,
                    onChanged: (v) => setBS(() => largeText = v),
                  ),
                ),
                const SizedBox(height: 24),
                _saveButton(() async {
                  await AppSettings().setLanguage(selectedLang);
                  await AppSettings().setTextScaleFactor(
                    largeText ? 1.25 : 1.0,
                  );

                  Locale locale = const Locale('en');
                  if (selectedLang == 'Bahasa Melayu') {
            ...
            child: Column(
              children: [
                ...
                _tileRow(
                  ...
                  'Get reminded to take your medicine',
                  trailing: Switch(
                    value: true,
                    activeThumbColor: _kBlue,
                    onChanged: (_) {},
                ...
                _tileRow(
                  ...
                  'Schedule Reminders',
                  'Appointment and schedule alerts',
                  trailing: Switch(
                    value: true,
                    activeThumbColor: _kBlue,
                    onChanged: (_) {},
                ...
                _tileRow(
                  ...
                  'Health Alerts',
                  'High risk health record warnings',
                  trailing: Switch(
                    value: true,
                    activeThumbColor: _kBlue,
                    onChanged: (_) {},
  ...
  // ─── Sessions ────────────────────────────────────────────────────────────
  void _openSessions() {
    SessionManager().init(userId: _targetUid);
            ...
            child: ListenableBuilder(
              ...
              builder: (ctx, child) {
                return Column(
                  children: [
                    Text(
                      'Customize your daily sessions (Morning, Afternoon, etc.) to group your schedule and medications.'
                          .tr(),
                      style: TextStyle(
                        color: Colors.grey.shade600,
                        fontSize: 13,
                            ...
                            children: [
                              IconButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (t != null) {
                                    final newList = List<CustomSession>.from(
                                      manager.sessions,
                                    );
                              ...
                              IconButton(
                                ...
                                onPressed: () async {
                                  ...
                                  newList.removeWhere((x) => x.id == s.id);
                                  await manager.updateSessions(
                                    newList,
                                    userId: _targetUid,
                                  );
                    ...
                    OutlinedButton.icon(
                      onPressed: () {
                        _showAddSessionDialog(ctx, manager);
                      },
                      icon: const Icon(Icons.add),
                      label: Text('Add Session'.tr()),
  ...
  void _showAddSessionDialog(BuildContext bctx, SessionManager manager) {
    ...
    showDialog(
      ...
      builder: (dctx) => StatefulBuilder(
        builder: (dctx, setDialogState) {
          return AlertDialog(
            title: Text('Add Session'.tr()),
            content: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                TextField(
                  controller: nameCtrl,
                  decoration: InputDecoration(labelText: 'Session Name'.tr()),
                ),
                const SizedBox(height: 16),
                Row(
                  children: [
            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: () async {
                  if (nameCtrl.text.isNotEmpty && selectedTime != null) {
                    final newList = List<CustomSession>.from(manager.sessions);
                    newList.add(
                      CustomSession(
                    ...
                    await manager.updateSessions(newList, userId: _targetUid);
                    syncAllMedicationReminders();
                    if (mounted) Navigator.pop(dctx);
                  }
                },
  ...
  Future<void> _manageCaregivers() async {
    showDialog(
      ...
      builder: (ctx) => Center(child: CircularProgressIndicator(color: _kBlue)),
    );
    try {
      ...
      final links = await db
          .from('care_link')
          .select('caregiver_id, emergency_contact_primary')
          .eq('elderly_id', uid);
      if (!mounted) return;
      ...
      if ((links as List).isEmpty) {
        _snack(
          'No caregivers linked yet. Ask your caregiver to scan your QR code.',
        );
        return;
      }
      ...
      final usersRes = await db
          .from('users')
          .select('user_id, fullname, phone_num')
          .inFilter('user_id', cgIds);
      ...
      showModalBottomSheet(
        ...
        builder: (ctx) => _buildBottomSheet(
          ctx,
          title: 'My Caregivers'.tr(),
          icon: Icons.medical_services_outlined,
          child: Column(
            children: [
              ...users.map((u) {
                final link = links.firstWhere(
                  (l) => l['caregiver_id'] == u['user_id'],
                  orElse: () => {},
                );
                        ...
                        onPressed: () async {
                          try {
                            await db
                                ...
                                .delete()
                                .eq('elderly_id', uid)
                                .eq('caregiver_id', u['user_id']);
                            if (ctx.mounted) Navigator.pop(ctx);
                            _snack('${'Unlinked'.tr()} ${u['fullname']}');
                          } catch (e) {
                            _snack(
                              '${'Error unlinking'.tr()}: $e',
                              isError: true,
                            );
                          }
                        },
      ...
      if (mounted) {
        Navigator.pop(context);
        _snack('${'Error'.tr()}: $e', isError: true);
      }
    }
  }
          ...
          children: [
            Container(
              ...
              child: Icon(
                icon,
                size: 18,
                color: isDestructive ? Colors.red : _kBlue,
              ),
            ),
            const SizedBox(width: 14),
            Expanded(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      color: isDestructive ? Colors.red : _kTextDark,
                      fontSize: 15,
                    ),
                  ),
                  Text(
